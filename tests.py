...
MATCH_VERIFIER = [subtitleIO.SubLine(['BROKEN EMBRACES', 'Los abrazos rotos'], datetime.time(0, 1, 12, 833*1000), datetime.time(0, 1, 19, 0) )]
...
class TestProcessConfig(unittest.TestCase):
  ...
  def test_read_config_json(self):
    result = subtitleIO.read_json(CONFIG_FILE)
    return 0
  def verify_order():
